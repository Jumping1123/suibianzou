...
-(void)setDevSenDataM:(DeviceSensorDataModel *)devSenDataM
{
    ...
    // 更新距离显示
    self.distanceLabel.text = [NSString stringWithFormat:@"%.fm", [LocCacuTool distanceWithPointA:_cardDataM.cardLocationCoor andPointB:self.devSenDataM.devSenCurrentLoc.coordinate]];
    ...
    float distanceXUnit = (kScreenSize.width + self.width) / 50;
    ...
    float baseY = kScreenSize.height * 0.5;
    float y = baseY + devSenDataM.devSenSlopeZ * distanceYUnit;
